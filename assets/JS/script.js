var typeData = new Typed(".role", {
  ...
  function contact() {
    window.location.href = "https://wa.me/9310557893/";
  };
  ...
  function sendEmail() {
    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9f9f9;">
      <div style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        ...
        <span style="margin: 0;">&copy; Sarthak Srivastava</span>
      </div>
      </div>
    </div>
  `;
    ...
    Email.send({
      ...
      Username: "sarthakkr470@gmail.com",
      Password: "7F7A46354FD1D0E6314D14D4381DBD609CEF",
      To: 'sarthakkr470@gmail.com',
      From: "sarthakkr470@gmail.com",
  ...
  document.addEventListener("visibilitychange", function () {
    if (document.visibilityState === "visible") {
      document.title = "Portfolio | Sarthak Srivastava";
    } else {
